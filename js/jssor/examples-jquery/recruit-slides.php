    ...
    <div id="slider1_container" style="position: absolute; top: 0px; left: 0px; width: 470px; height: 300px;  margin:auto; ">
        <!-- Loading Screen -->
        ...
        <div data-u="arrowright" class="jssora051" style="width:55px;height:55px;top:0px;right:-50px;" data-autocenter="2" data-scale="0.75" data-scale-right="0.75">
            <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
