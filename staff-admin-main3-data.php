<?php
include "dblink.php";
$result = $conn->query("SELECT DISTINCT st.StaffID,st.Department,st.MobileNumber,st.TelNumber,st.Email,st.EducationBackground,st.ConsultantStatus,
                        ...
                        WHERE st.Department = d.Department AND st.StaffID =".$_GET['SID']);
